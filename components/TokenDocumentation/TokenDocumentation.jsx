  ...
  const TabContent = {
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className={theme.text}>60%</span>
              </div>
              <div className="flex items-center justify-between">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-fuchsia-500">10%</span>
              </div>
              <div className="flex items-center justify-between">
    ...
    roadmap: (
      <div className="space-y-12">
        <div>
          <h3 className="text-xl text-fuchsia-500 mb-4">Phase 1 - Q3 2025</h3>
          <ul className={`space-y-2 ${theme.textSecondary}`}>
        ...
        <div>
          <h3 className="text-xl text-fuchsia-500 mb-4">Phase 2 - Q4 2025</h3>
          <ul className={`space-y-2 ${theme.textSecondary}`}>
        ...
        <div>
          <h3 className="text-xl text-fuchsia-500 mb-4">Phase 3 - Q1 2026</h3>
          <ul className={`space-y-2 ${theme.textSecondary}`}>
